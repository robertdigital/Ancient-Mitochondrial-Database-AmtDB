...
df = pd.DataFrame(final, columns=["info","seq_length","A","C","T","G","GC","CG","AT","TA","AC", "CA","AG", "GA","CT","TC","GT","TG","AA","CC","TT","GG","pGC","pCG","pAT","pTA","pAC","pCA","pAG","pGA","pCT","pTC", "pGT","pTG","pAA","pCC","pTT","pGG"])
df.to_csv(filename[:-3]+".csv", sep='\t', encoding='utf-8')
